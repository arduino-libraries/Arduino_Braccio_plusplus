...
#if defined (ESP32)
  #include "Processors/TFT_eSPI_ESP32.cx"
#elif defined (ESP8266)
  #include "Processors/TFT_eSPI_ESP8266.cx"
#elif defined (STM32) // (_VARIANT_ARDUINO_STM32_) stm32_def.h
  #include "Processors/TFT_eSPI_STM32.cx"
#elif defined (ARDUINO_ARCH_RP2040) || defined (ARDUINO_ARCH_MBED) // Raspberry Pi Pico
  #include "Processors/TFT_eSPI_RP2040.cx"
#else
  #include "Processors/TFT_eSPI_Generic.cx"
#endif
...
void TFT_eSPI::setWindow(int32_t x0, int32_t y0, int32_t x1, int32_t y1)
{
  ...
  #if (defined(ARDUINO_ARCH_RP2040) || defined(ARDUINO_ARCH_MBED)) && !defined(TFT_PARALLEL_8BIT)
